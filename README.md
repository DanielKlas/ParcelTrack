...
## Instructions
Go to 'release' branch, download it and run ParcelTrack.exe. It comes with pre-installed data. If you wish to use your own data, simply delete **parceltrack_couriers.csv** and **parceltrack_parcels.csv**.
